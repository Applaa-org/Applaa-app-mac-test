...
test("edit code", async ({ po }) => {
  const editedFilePath = path.join("src", "components", "made-with-applaa.tsx");
  ...
  await po.page.getByText("made-with-applaa.tsx").click();
  await po.page
    .getByRole("code")
    .locator("div")
  ...
  await po.page
    ...
    .fill("export const MadeWithApplaa = ;");
  ...
  expect(editedFile).toContain("export const MadeWithApplaa = ;");
});
