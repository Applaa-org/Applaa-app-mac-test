...
## System Information
- Applaa Version: ${debugInfo.dyadVersion}
...
`;
      ...
      const githubIssueUrl = `https://github.com/applaa/applaa/issues/new?title=${encodedTitle}&labels=bug,filed-from-app&body=${encodedBody}`;
      ...
      IpcClient.getInstance().openExternalUrl(
        "https://github.com/applaa/applaa/issues/new",
      );
    } finally {
      setIsLoading(false);
    }
...
`;
    ...
    const githubIssueUrl = `https://github.com/applaa/applaa/issues/new?title=${encodedTitle}&labels=support&body=${encodedBody}`;
          ...
          <div className="space-y-4 overflow-y-auto flex-grow">
            ...
            <div className="border rounded-md p-3">
              ...
              <div className="text-sm bg-slate-50 dark:bg-slate-900 rounded p-2 max-h-32 overflow-y-auto">
                <p>Applaa Version: {chatLogsData.debugInfo.dyadVersion}</p>
