...
interface SimpleAppTypeSelectorProps {
  onSelection: (type: 'web' | 'expo' | 'flutter') => void;
  className?: string;
}
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="text-center">
        <p className="text-xs text-gray-500">We auto-select frameworks (Web: React, Mobile: Expo). You can change later in settings.</p>
      </div>
    </div>
  );
}
