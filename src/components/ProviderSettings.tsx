...
export function ProviderSettingsGrid() {
  ...
  const handleProviderClick = (providerId: string) => {
    // Navigate to the provider settings page
    navigate({
        ...
        {providers
          ...
          .map((provider: LanguageModelProvider) => {
            ...
            return (
              <div
                key={provider.id}
                className="relative transition-all hover:shadow-md hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
