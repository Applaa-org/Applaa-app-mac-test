...
export function ContextFilesPicker() {
  ...
  const isSmartContextEnabled =
    settings?.enableApplaaPro === true && (settings?.enableProSmartFilesContextMode === true || settings?.semanticContextEnabled === true);
      ...
      >
        <div className="relative space-y-4">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    {isSmartContextEnabled ? (
                      ...
                      <p>By default, Applaa uses your whole codebase.</p>
                    )}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
          ...
          <TooltipProvider>
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "Applaa will use Spark Context to automatically find the most relevant files to use as context."
                    : "Applaa will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
          ...
          {isSmartContextEnabled && (
            <div className="pt-2">
              <div>
                <h3 className="font-medium">Spark Context Auto-includes</h3>
                <p className="text-sm text-muted-foreground">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
