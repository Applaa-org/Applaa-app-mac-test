...
export default function ConfirmationDialog({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 pointer-events-none">
      <div className="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 text-center shadow-2xl transition-all w-full max-w-lg pointer-events-auto border border-gray-200 dark:border-gray-700">
